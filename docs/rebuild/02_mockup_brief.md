...
字級（px／行高）：h1 24/32 700；h2 18/26 700；正文 16/24 400；次文 14/20 400；chip 13/16 500；細字 12/16 400。
...
1. 8.4 狀態表中 S1／S2／S3／S4／S6 的 P0 狀態每格都有對應畫面或疊放卡。
