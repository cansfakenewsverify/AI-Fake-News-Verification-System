...
| 組員分工 | **2026-09-19 組內確認**：廖晢勛＝A 測試負責人／操作者（不負責上台簡報）、石岱勳＝B 介面測試、姚睿＝C 績效與品質數據、張宇宏＝D 文件與審查、廖昱翔＝E 影片與簡報（上台）。已填入測試計畫書 v1.2、投影片第 1 張與第 12 張講稿。（2026-09-16 的草擬分配、v1.1 的留白版皆已取代）報告資料統一放 `presentations/2026-09_進度報告/` | 2026-09-19 對話 |
