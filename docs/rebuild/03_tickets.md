...
## 0.5 報告週範圍（2026-09-15 負責人選 A：報告週切片）

原排程一週 152h 做不完，負責人選 A：**報告前只做 3 分鐘影片看得到的東西**。下表是唯一依據；總覽表的「排程」欄在報告週以此為準。

**報告週要做**
- 已完成或進行中：P-01～P-13、S-12、B-01～B-19、T-01～T-03、T-05～T-07、D-01～D-04、O-14
- 資料：D-05（負責人審清洗結果後套用）
- 後端：B-20、B-21、B-22
- 前端：P-14～P-17、S-01～S-10（套用 §3.2 第二批刪減：S-09 篩選只留「全部／未查證」、S-10 單次 `limit=60` 不做載入更多與四格統計）
- Threads 模擬模式閉環：T-08～T-11
- 部署與素材：O-03、O-04、O-05、O-06、O-26、O-08、O-12（sim 版）、O-13、O-17、O-18、O-19、O-20、O-21（只彩排 sim）

**報告後才做**
- Threads 真帳號串接：O-07、O-09、T-12～T-16、O-27
- /bot 狀態頁：S-11（影片改用終端機 log＋`replies.jsonl` 呈現機器人回覆）
- 評測與效能：B-23、O-11、O-22、O-23（報告引用既有 accuracy 96%／FN=0）
- 介面測試與 a11y：P-18、O-24、O-28
- 測試計畫書 §4–6：O-15、O-16
- 發佈前凍結：O-25；文件同步 B-25；其餘 P1／P2 維持原狀
