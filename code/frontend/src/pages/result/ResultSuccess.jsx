...
//    colours only from the backend frame_type. Chips: "confidence high/mid/low" toggles confidence_note;
...
// The "similar checks in the knowledge base" section (element 5) stays hidden this week (P1, D-18).
